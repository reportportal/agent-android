...
The latest version: 5.2.4. Please use `Maven Central` link above to get the agent. Minimal supported API version: 26
...
5. In the `dependencies` section:
   ...
   * Add Report Portal agent dependency:
   ```groovy
   implementation ('com.epam.reportportal:agent-android-junit5:5.2.4') {
